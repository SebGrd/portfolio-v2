...
<head>
    ...
    <meta name="description" content="Portfolio de Sébastien Gaudard, intégrateur web.">
    <title>Sébastien Gaudard | Portfolio</title>

    <link rel="shortcut icon" href="src/img/favicon.png" type="image/x-icon">

    <link href="https://fonts.googleapis.com/css?family=Lato:400,400i,700,700i&display=swap" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Nunito:400,400i,700,700i,800,800i&display=swap"
          rel="stylesheet">
...
<header>
    <h1><a href="/">Sébastien Gaudard</a></h1>
    ...
    <nav>
        ...
        <ul>
            <li><a href="/centre-de-formation">Centre de formation</a></li>
            <li><a href="/entreprise">Entreprise actuelle</a></li>
...
<noscript>
    <div class="container mt-l py-l">
        <h2>Votre navigateur n'est pas supporté ou les script ont été bloqués.</h2>
        <p>
            Merci de changer de navigateur ou
            d'activer
            les scripts sur ce site afin de profiter du fonctionnement voulu.
        </p>
    </div>
</noscript>
